...
import pytest
from aiq_multi_frameworks_llm_router.register import MultiFrameworksLLMRouterWorkflowConfig
...
async def test_full_workflow():
    ...
    package_name = inspect.getmodule(MultiFrameworksLLMRouterWorkflowConfig).__package__
